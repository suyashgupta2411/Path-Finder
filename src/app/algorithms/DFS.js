...
export const DFS = (grid, startCell, endCell) => {
  ...
  while (unvisitedCellsStack.length > 0) {
    let currentCell = unvisitedCellsStack.shift(); // for DFS we want to go in the same direction till we hit the border so we access the item which is added last in the array
